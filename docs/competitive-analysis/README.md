...
| [`04-parity-plan.md`](04-parity-plan.md) | Prioritised roadmap to on-par-or-better, mapped onto Inroad's single-Go-module architecture. |

## Headline verdict (2026-09-07)
...
- complaint / FBL ingestion and seed inbox-placement testing
- outbound webhooks + an integrations ecosystem (CRM sync, chat, iPaaS connectors)
