...
func (q *Queries) SetStepOrder(ctx context.Context, arg SetStepOrderParams) error {
	_, err := q.db.Exec(ctx, setStepOrder,
		arg.ID,
		arg.CampaignID,
		arg.WorkspaceID,
		arg.StepOrder,
...
func (q *Queries) ShiftStepOrders(ctx context.Context, arg ShiftStepOrdersParams) error {
	_, err := q.db.Exec(ctx, shiftStepOrders, arg.CampaignID, arg.WorkspaceID, arg.StepOrder)
	return err
}
