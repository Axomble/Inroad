...
--
-- Why: PurgeDeliverabilityEvents walks deliverability_events oldest-first by
-- (received_at, id) with no workspace predicate; the existing indexes lead with
-- workspace_id or send_id.
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deliverability_events_received_at
