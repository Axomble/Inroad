...
export function Input({ className, type, ref, ...props }: InputProps) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'flex h-9 w-full min-w-0 rounded-md border border-input bg-surface-2 px-3 py-1 text-sm text-foreground shadow-[inset_0_1px_2px_rgba(0,0,0,0.25)] transition-colors outline-none',
